...
setwd('/media/Files/JHU/Infrastructure/randomgraphs2011/current/statistics/data')
...
setwd('/media/Files/JHU/Infrastructure/randomgraphs2011/current/statistics/statsCode')
...
#setwd('/media/Files/JHU/Infrastructure/randomgraphs2011/current/statistics/results')
