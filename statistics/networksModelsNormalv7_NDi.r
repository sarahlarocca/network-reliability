...
Ythan <- read.table('Ythan_NDi.txt',header=FALSE)
...
Eco <- read.table('EcoUC_NDi.txt',header=FALSE)
...
Terr <- read.table('Terr_NDi.txt',header=FALSE)
...
source('holdoutsBetaregS1fullV2_NDi.r')
source('holdoutsBetaregS10fullV2_NDi.r')
source('holdoutsBetaregS25fullV2_NDi.r')
source('holdoutsBetaregS50fullV2_NDi.r')
source('holdoutsBetaregS75fullV2_NDi.r')
...
holdouts.mse.Terr.NDi <- rbind(MSE.model.betareg.S1.Terr.NDi, MSE.model.betareg.S10.Terr.NDi, MSE.model.betareg.S25.Terr.NDi, MSE.model.betareg.S50.Terr.NDi, MSE.model.betareg.S75.Terr.NDi)
holdouts.mse.Eco.NDi <- rbind(MSE.model.betareg.S1.Eco.NDi, MSE.model.betareg.S10.Eco.NDi, MSE.model.betareg.S25.Eco.NDi, MSE.model.betareg.S50.Eco.NDi, MSE.model.betareg.S75.Eco.NDi)
...
holdouts.mae.Terr.NDi <- rbind(MAE.model.betareg.S1.Terr.NDi, MAE.model.betareg.S10.Terr.NDi, MAE.model.betareg.S25.Terr.NDi, MAE.model.betareg.S50.Terr.NDi, MAE.model.betareg.S75.Terr.NDi)
holdouts.mae.Eco.NDi <- rbind(MAE.model.betareg.S1.Eco.NDi, MAE.model.betareg.S10.Eco.NDi, MAE.model.betareg.S25.Eco.NDi, MAE.model.betareg.S50.Eco.NDi, MAE.model.betareg.S75.Eco.NDi)
...
real.S.rel.IEEE118.NDi <- rbind(S1.rel.IEEE118, S10.rel.IEEE118, S25.rel.IEEE118, S50.rel.IEEE118, S75.rel.IEEE118)
real.S.rel.IEEE300.NDi <- rbind(S1.rel.IEEE300, S10.rel.IEEE300, S25.rel.IEEE300, S50.rel.IEEE300, S75.rel.IEEE300)
real.S.rel.Ythan.NDi <- rbind(S1.rel.Ythan, S10.rel.Ythan, S25.rel.Ythan, S50.rel.Ythan, S75.rel.Ythan)
real.S.rel.Eco.NDi <- rbind(S1.rel.Eco, S10.rel.Eco, S25.rel.Eco, S50.rel.Eco, S75.rel.Eco)
real.S.rel.Terr.NDi <- rbind(S1.rel.Terr, S10.rel.Terr, S25.rel.Terr, S50.rel.Terr, S75.rel.Terr)
...
prediction.S.rel.IEEE118.NDi <- rbind(prediction.S1.IEEE118.NDi, prediction.S10.IEEE118.NDi, prediction.S25.IEEE118.NDi, prediction.S50.IEEE118.NDi, prediction.S75.IEEE118.NDi)
prediction.S.rel.IEEE300.NDi <- rbind(prediction.S1.IEEE300.NDi, prediction.S10.IEEE300.NDi, prediction.S25.IEEE300.NDi, prediction.S50.IEEE300.NDi, prediction.S75.IEEE300.NDi)
prediction.S.rel.Ythan.NDi <- rbind(prediction.S1.Ythan.NDi, prediction.S10.Ythan.NDi, prediction.S25.Ythan.NDi, prediction.S50.Ythan.NDi, prediction.S75.Ythan.NDi)
prediction.S.rel.Eco.NDi <- rbind(prediction.S1.Eco.NDi, prediction.S10.Eco.NDi, prediction.S25.Eco.NDi, prediction.S50.Eco.NDi, prediction.S75.Eco.NDi)
prediction.S.rel.Terr.NDi <- rbind(prediction.S1.Terr.NDi, prediction.S10.Terr.NDi, prediction.S25.Terr.NDi, prediction.S50.Terr.NDi, prediction.S75.Terr.NDi)
