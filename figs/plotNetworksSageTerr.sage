...
mat_contents = sio.loadmat('/media/Files/JHU/Infrastructure/networks2012/plots/TerrPlot.mat')

networkInit = mat_contents['TerrPlotInit']
network10 = mat_contents['TerrPlot10']
network25 = mat_contents['TerrPlot25']
network50 = mat_contents['TerrPlot50']
network75 = mat_contents['TerrPlot75']

posTerr = load('posTerr')
...
#Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, layout='spring', iterations=1000000, save_pos=True).save('TerrInitplot.pdf',figsize=(8,8))

Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, pos = posTerr).save('TerrInitplot.pdf',figsize=(8,8))

posTerr = Ginit.get_pos()

save(posTerr, 'posTerr')
...
G10.plot(vertex_colors=vertex_colors_10, vertex_labels=False, vertex_size=100, pos = posTerr).save('Terr10plot.pdf',figsize=(8,8))
...
G25.plot(vertex_colors=vertex_colors_25, vertex_labels=False, vertex_size=100, pos = posTerr).save('Terr25plot.pdf',figsize=(8,8))
...
G50.plot(vertex_colors=vertex_colors_50, vertex_labels=False, vertex_size=100, pos = posTerr).save('Terr50plot.pdf',figsize=(8,8))
...
G75.plot(vertex_colors=vertex_colors_75, vertex_labels=False, vertex_size=100, pos = posTerr).save('Terr75plot.pdf',figsize=(8,8))
