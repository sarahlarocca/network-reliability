...
Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, layout='spring', iterations=1000000, save_pos=True).save('Ainitplot.pdf',figsize=(8,8))

Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, pos = pos).save('Ainitplot.pdf',figsize=(8,8))
...
G10.plot(vertex_colors=vertex_colors_10, vertex_labels=False, vertex_size=100, pos = posA).save('A10plot.pdf',figsize=(8,8))
...
G25.plot(vertex_colors=vertex_colors_25, vertex_labels=False, vertex_size=100, pos = posA).save('A25plot.pdf',figsize=(8,8))
...
G50.plot(vertex_colors=vertex_colors_50, vertex_labels=False, vertex_size=100, pos = posA).save('A50plot.pdf',figsize=(8,8))
...
G75.plot(vertex_colors=vertex_colors_75, vertex_labels=False, vertex_size=100, pos = posA).save('A75plot.pdf',figsize=(8,8))
