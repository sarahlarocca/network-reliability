...
betareg.NBi.plot.data <- betareg.NBi[(betareg.NBi$num != '1') & (betareg.NBi$var != 'Intercept') & (betareg.NBi$var != 'Phi'),]
...
dev.off()
ggsave(filename = 'betareg_NBi_V11.pdf')
...
dev.off()
ggsave(filename = 'meanS_NBi_V11.pdf')
...
ggsave(filename = 'MAE_NBi_V11.pdf')
