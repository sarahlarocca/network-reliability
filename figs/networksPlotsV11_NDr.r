...
betareg.NDr.plot.data <- betareg.NDr[(betareg.NDr$num != '1') & (betareg.NDr$var != 'Intercept') & (betareg.NDr$var != 'Phi'),]
...
dev.off()
ggsave(filename = 'betareg_NDr_V11.pdf')
...
dev.off()
ggsave(filename = 'meanS_NDr_V11.pdf')
...
ggsave(filename = 'MAE_NDr_V11.pdf')
