...
mat_contents = sio.loadmat('/media/Files/JHU/Infrastructure/networks2012/plots/EcoPlot.mat')

networkInit = mat_contents['EcoPlotInit']
network10 = mat_contents['EcoPlot10']
network25 = mat_contents['EcoPlot25']
network50 = mat_contents['EcoPlot50']
network75 = mat_contents['EcoPlot75']
...
Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, layout='spring', iterations=1000000, save_pos=True).save('EcoInitplot.pdf',figsize=(8,8))

Ginit.plot(vertex_colors=vertex_colors_init, vertex_labels=False, vertex_size=100, pos = posEco).save('EcoInitplot.pdf',figsize=(8,8))

posEco = Ginit.get_pos()
...
G10.plot(vertex_colors=vertex_colors_10, vertex_labels=False, vertex_size=100, pos = posEco).save('Eco10plot.pdf',figsize=(8,8))
...
G25.plot(vertex_colors=vertex_colors_25, vertex_labels=False, vertex_size=100, pos = posEco).save('Eco25plot.pdf',figsize=(8,8))
...
G50.plot(vertex_colors=vertex_colors_50, vertex_labels=False, vertex_size=100, pos = posEco).save('Eco50plot.pdf',figsize=(8,8))
...
G75.plot(vertex_colors=vertex_colors_75, vertex_labels=False, vertex_size=100, pos = posEco).save('Eco75plot.pdf',figsize=(8,8))
...
Ginit.sumpathlength/((nEco*nEco)-nEco)
